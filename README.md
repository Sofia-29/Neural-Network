...
1. Start by opening a WSL terminal in the folder "src/controller", then run the FastApi server with the following command: uvicorn neural_network:app --reload
